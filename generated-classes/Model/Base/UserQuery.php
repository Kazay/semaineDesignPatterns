...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'app', $modelName = '\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, pseudo, firstname, lastname, email FROM user WHERE id = :p0';
        try {
     ...
     * $query->filterByPseudo('%fooValue%', Criteria::LIKE); // WHERE pseudo LIKE '%fooValue%'
     * </code>
     *
